...
use Bertshang\Api\Formatters\BaseFormatter;
use Bertshang\Api\Reporters\ReporterInterface;
    ...
    public function render($request, Exception $e)
    {
        ...
        if ($this->config['add_cors_headers']) {
            if (!class_exists(CorsService::class)) {
                throw new InvalidArgumentException(
                    'asm89/stack-cors has not been installed. Bertshang\Api needs it for adding CORS headers to response.'
                );
            }
